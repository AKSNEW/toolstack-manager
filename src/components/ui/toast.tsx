...
/**
 * ToastProvider - контекст для управления тостами
 * Должен оборачивать часть приложения, где будут использоваться тосты
 */
const ToastProvider = ToastPrimitives.Provider

/**
 * ToastViewport - контейнер, где будут появляться тосты
 * Определяет позиционирование и максимальное количество одновременно отображаемых тостов
 */
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4", // Мобильная версия (тосты снизу)
      "sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]", // Десктопная версия
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      // Стили для деструктивного варианта
